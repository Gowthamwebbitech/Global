                ...
                <div class="rs-header-inner rs-sticky-header" id="rs-sticky-header">
                            ...
                            <ul class="multipage-menu">
                                ...
                                <li class="menu-item-has-children">
                                    ...
                                    <ul class="submenu last-children">
                                        <li>
                                            <a href="bearing.php">Bearing</a>
                                        </li>
                                        <li>
                                            <a href="linear.php">Linear Motions</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="">
                    ...
                    <div class="rs-header-right">
                        ...
                        <div class="rs-header-btn">
                            <a class="rs-btn has-theme-light-green has-icon has-bg" href="#0">Get In Touch
                                <span class="icon-box">
        ...
        <div class="offcanvas-area has-theme-green" data-lenis-prevent>
            <div class="offcanvas-wrapper">
                <div class="offcanvas-content">
                    ...
                    <div class="offcanvas-about mb-30 d-none d-lg-block">
                    ...
                    <div class="offcanvas-gallery d-none d-lg-block">
